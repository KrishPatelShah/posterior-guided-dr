#!/bin/bash
#SBATCH -J pgdr_C4_pgdr_2.0_seed0
#SBATCH -o pgdr/tacc/jobs/logs/C4_pgdr_2.0_seed0_%j.out
#SBATCH -e pgdr/tacc/jobs/logs/C4_pgdr_2.0_seed0_%j.err
#SBATCH -p gpu-a100
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -t 12:00:00
